...
function getFragmentQueryDocument(document, fragmentName) {
  ...
  document.definitions.forEach(function(definition) {
    if (definition.kind === "OperationDefinition") {
      throw newInvariantError(70, definition.operation, definition.name ? " named '".concat(definition.name.value, "'") : "");
    }
                ...
                if (isApolloPayloadResult(result2)) {
                  ...
                  if ("errors" in result2) {
                    next = __assign(__assign({}, next), {
                      extensions: __assign(__assign({}, "extensions" in next ? next.extensions : null), (_d = {}, _d[PROTOCOL_ERRORS_SYMBOL] = result2.errors, _d))
                    });
                  }
                  nextValue(next);
                } else {
...
//# sourceMappingURL=chunk-AWMCSNRT.js.map
